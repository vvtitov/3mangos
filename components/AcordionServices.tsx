    ...
    <div className="w-full h-full">
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger className="bg-clip-text dark:bg-gradient-to-l bg-gradient-to-r from-primary to-secondary text-transparent font-medium text-2xl lg:text-3xl">
