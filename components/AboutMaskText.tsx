...
export function AboutMaskText() {
  ...
  return (
    <div className="h-full w-full flex items-center justify-center overflow-hidden bg-cover bg-center mb-[0rem] lg:mb-[-5rem]">
      <MaskContainer
        revealText={
          <p className="max-w-4xl mx-auto text-transparent bg-clip-text bg-gradient-to-br from-primary via-primary/70 to-primary text-center text-5xl lg:text-7xl font-bold p-2">
