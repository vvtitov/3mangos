  ...
  return (
    <div className="h-full w-full flex items-center justify-center overflow-hidden bg-cover bg-center mb-[0rem] lg:mb-[-5rem]">
      ...
      >
        ...
        &apos;
        <span className="italic">only you three knew how to program…</span>
        &quot; To his surprise, the mangos glowed and, through some bizarre
        cosmic glitch, he started writing flawless code. Absolutely stuned,
        founded <strong className="text-primary">THREE MANGOS</strong>, claiming
        his secret team of coding mangos powered the company. Investors thought
        it was a joke—until he started delivering top-tier software. To this
        day, no one knows the truth… <br /> except for the three very, very wise
        mangos.
      </MaskContainer>
    </div>
  );
